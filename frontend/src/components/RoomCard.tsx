import { Card, CardActions, CardContent, CardHeader, FormControlLabel, FormGroup, FormLabel, Switch, Typography } from "@mui/material";
    ...
    return (
        <Card sx={{
            ...
            <CardContent>
                {sensors ? (
                    sensors.map((sensor) => (
                        <Typography key={sensor.id}>{sensor.sensor_type}: {sensor.value + sensor.unit}</Typography>
                    ))
                ) : null}
            </CardContent>
            <CardActions>
